#!/bin/sh
# 创建数据库
echo "GRANT ALL PRIVILEGES ON *.* TO 'keystone'@'%' IDENTIFIED BY '123456';"|mysql -u root -p123456
...
echo "GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'controller' IDENTIFIED BY '123456';"|mysql -u root -p123456
